      ...
      {user && (
        <>
          ...
          <div className="bg-white dark:bg-dark-hover rounded-xl p-6 border border-line/50 dark:border-line/10 mb-6">
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-6">
                <div className="w-24 h-28 rounded-xl overflow-hidden flex-shrink-0 bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-bold text-4xl">
          ...
          {activeTab === "overview" && (
            ...
            {/* Business Profiles */}
            <div className="mt-6 bg-white dark:bg-dark-hover rounded-xl p-6 border border-line/50 dark:border-line/10">
              <div className="mb-4 flex items-center justify-between">
                <h3 className="font-bold text-ink dark:text-white">Business Profiles</h3>
                <span className="text-xs text-muted dark:text-white/60">
                  {user.businessProfiles?.length || 0} {user.businessProfiles?.length === 1 ? "profile" : "profiles"}
                </span>
              </div>

              {!user.businessProfiles || user.businessProfiles.length === 0 ? (
                <p className="text-sm text-muted dark:text-white/60">
                  This user hasn't created any business profiles.
                </p>
              ) : (
